        ...
        <div class="mb-6">
            <a href="{{ route('auth.apple') }}" 
               class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-black hover:bg-gray-800 transition-colors focus:ring-2 focus:ring-gray-500 focus:border-gray-500">
                ...
                <span class="text-white font-medium">Continue with Apple</span>
            </a>
        </div> -->
...
<button type="submit" 
                    class="w-full bg-black text-white py-2 px-4 rounded-md hover:bg-gray-800 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors font-medium">
